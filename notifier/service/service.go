...
func (s *service) DeleteNotifications(ctx context.Context, id uuid.UUID) error {
	return s.store.DeleteNotifications(ctx, id)
}
...
func New(ctx context.Context, opts Opts) (*service, error) {
	...
	if opts.Webhook != nil && opts.AMQP != nil {
		return nil, fmt.Errorf("notifier does not support both AMPQ and Webhook delivery")
	}
